...
const Intro = () => {
  ...
  return (
    <section className="section" id='intro'>
      <div className="w-full md:h-1/2 h-full max-md:flex max-md:flex-col max-md:justify-center bg-blue-400 pt-16 font-nunito text-center text-white">
      ...
      <div className="w-full md:h-1/2 h-full flex max-md:flex-col">
        <div className="md:p-8 md:w-1/2 h-full bg-red-500 text-white font-nunito text-center lg:text-3xl text-xl flex flex-col justify-center max-md:pt-16">
        ...
        <div className="md:w-1/2 h-full bg-purple-700 text-white font-nunito text-center lg:text-3xl text-xl  flex flex-col justify-center">
