...
const Intro = () => {
  ...
  return (
    <section className="section" id='intro'>
      <div className="w-full md:h-1/2 h-full max-md:flex max-md:flex-col max-md:justify-evenly bg-blue-400 md:pt-16 font-nunito text-center text-white">
      ...
      <div className="w-full md:h-1/2 h-full flex max-md:flex-col">
        <div className="md:w-1/2 h-full bg-red-500 text-white font-nunito text-center lg:text-3xl text-xl flex flex-col justify-center">
            <h3>My name is Phil, but I'd like you to call me MONTAYYNE.</h3>
        ...
        <div className="md:w-1/2 h-full bg-yellow-500 text-white font-nunito text-center lg:text-3xl text-xl  flex flex-col justify-center">
            ...
            <Button
                ...
                mx={'auto'}
                mt={10}
                _hover={{ bg: 'white', color: 'yellow.500' }}
